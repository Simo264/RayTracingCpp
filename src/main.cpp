...
{
  // Camera
  constexpr auto camera_position = glm::vec3(0.f);
  constexpr auto image_resolution = glm::ivec2(854, 480);
  Camera camera(camera_position, image_resolution);
  ...
  // World
  auto ground = std::make_shared<Plane>(glm::vec3(0.f, -0.5f, 0.f), 
                                        glm::vec3(0.f, 1.f, 0.f), 
                                        material_ground);
  auto sphere_center = std::make_shared<Sphere>(glm::vec3(0.0f, 0.0f, -1.2f),
                                                0.5f, 
                                                material_sphere_center);
  auto sphere_left = std::make_shared<Sphere>(glm::vec3(-1.0f, 0.0f, -1.0f), 
                                              0.5f, 
                                              material_sphere_left);
  auto sphere_right = std::make_shared<Sphere>(glm::vec3(1.0f, 0.0f, -1.0f), 
                                               0.5f, 
